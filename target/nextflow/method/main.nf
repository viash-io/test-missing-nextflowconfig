// method build_0_7_2
// 
// This wrapper script is auto-generated by viash 0.7.2 and is thus a derivative
...
thisConfig = processConfig(jsonSlurper.parseText('''{
  "functionality" : {
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/test-missing-nextflowconfig/test-missing-nextflowconfig/src/method/config.vsh.yaml"
      },
      {
        "type" : "file",
        "path" : "resource.txt",
    ...
    "test_resources" : [
      ...
      },
      {
        "type" : "file",
        "path" : "resources",
        "parent" : "file:///home/runner/work/test-missing-nextflowconfig/test-missing-nextflowconfig/"
      }
    ],
    "status" : "enabled",
    "requirements" : {
  ...
  "platforms" : [
    {
      ...
      "id" : "docker",
      "image" : "ubuntu:latest",
      "target_organization" : "viash-io/test-nextflow-wave-fusion",
      "target_registry" : "ghcr.io",
      "namespace_separator" : "/",
      "resolve_volume" : "Automatic",
      "chown" : true,
      "setup_strategy" : "ifneedbepullelsecachedbuild",
      "target_image_source" : "https://github.com/viash-io/test-nextflow-wave-fusion"
    },
    {
      "type" : "nextflow",
      "id" : "nextflow",
  ...
  "info" : {
    "config" : "/home/runner/work/test-missing-nextflowconfig/test-missing-nextflowconfig/src/method/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.2",
    "git_commit" : "0a46d192b621c975d865fa86030caebc6f0b1641",
    "git_remote" : "https://github.com/viash-io/test-missing-nextflowconfig"
  }
}'''))
...
$( if [ ! -z ${VIASH_PAR_MULTIPLE_INPUT+x} ]; then echo "${VIASH_PAR_MULTIPLE_INPUT}" | sed "s#'#'\\"'\\"'#g;s#.*#par_multiple_input='&'#" ; else echo "# par_multiple_input="; fi )
$( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "${VIASH_PAR_OUTPUT}" | sed "s#'#'\\"'\\"'#g;s#.*#par_output='&'#" ; else echo "# par_output="; fi )
$( if [ ! -z ${VIASH_PAR_MULTIPLE_OUTPUT+x} ]; then echo "${VIASH_PAR_MULTIPLE_OUTPUT}" | sed "s#'#'\\"'\\"'#g;s#.*#par_multiple_output='&'#" ; else echo "# par_multiple_output="; fi )
$( if [ ! -z ${VIASH_PAR_OUTPUT_RESOURCE+x} ]; then echo "${VIASH_PAR_OUTPUT_RESOURCE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_output_resource='&'#" ; else echo "# par_output_resource="; fi )
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-io/test-nextflow-wave-fusion/method",
    "tag" : "build_0_7_2"
  },
  "tag" : "$id"
}'''),
